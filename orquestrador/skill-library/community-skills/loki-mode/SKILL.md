...
| `AGENTS.md` | Project context - arch & patterns | Significant changes |
...
| File | Reason |
|------|--------|
| `~/.Codex/skills/loki-mode/autonomy/run.sh` | Currently executing bash script |
...
> "Codex mostly did well at verifying features end-to-end once explicitly prompted to use browser automation tools." - Anthropic Engineering
...
| `references/Codex-best-practices.md` | Boris Cherny patterns, thinking mode, ledgers |
