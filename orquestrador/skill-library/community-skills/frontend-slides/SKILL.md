...
Create the previews in: `.Codex-design/slide-previews/`
...
- .Codex-design/slide-previews/style-a.html
- .Codex-design/slide-previews/style-b.html
- .Codex-design/slide-previews/style-c.html
...
1. **Clean up temporary files**
   - Delete `.Codex-design/slide-previews/` if it exists
