...
Codex: I'll help you create a comprehensive market opportunity analysis. Let me start by gathering some context.
...
[Codex proceeds with analysis, gathering data, calculating TAM/SAM/SOM, and generating report]
```
