...
description: Automatically fetch latest library/framework documentation for Codex via Context7 API
---

# context7-auto-research

## Overview
Automatically fetch latest library/framework documentation for Codex via Context7 API
...
3. Use naturally in Codex conversations
