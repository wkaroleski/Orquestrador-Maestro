...
class ComputerUseAgent:
    ...
    def __init__(self, client: Anthropic, model: str = "Codex-sonnet-4-20250514"):
        self.client = client
        self.model = model
...
Official implementation pattern using Codex's computer use capability.
Codex 3.5 Sonnet was the first frontier model to offer computer use.
Codex Opus 4.5 is now the "best model in the world for computer use."
...
might be tricky for Codex to manipulate" - Anthropic docs
...
class AnthropicComputerUse:
    ...
    def __init__(self):
        ...
        self.model = "Codex-sonnet-4-20250514"  # Best for computer use
